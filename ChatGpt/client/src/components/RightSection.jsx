...
function RightSection() {
  ...
  const adjustInputHeight = () => {
    if (inputContainerRef.current) {
      ...
      inputContainer.style.overflow = "hidden"; // Added this line
    }
  };
          ...
          >
            <div className="relative flex h-full flex-1 flex-col">
              <div
                ...
                className="flex flex-col w-full flex-grow py-3 relative border border-black/10 dark:border-gray-900/50 text-white rounded-md bg-[rgba(64,65,79, var(--tw-bg-opacity))] overflow-hidden"
              >
                <input
